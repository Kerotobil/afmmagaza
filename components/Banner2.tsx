  ...
  return (
    <div className="bg-white w-full shadow-sm mx-auto overflow-hidden">
      <div className="grid grid-cols-12 ml-2  md:gap-8 md:h-full relative ">
        <div className="mt-10 mx-auto md:mt-24 md:mb-24 relative z-10 col-span-12 md:col-span-6 text-center md:text-left md:max-w-2xl">
          <div className="mx-auto">
            <p className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none font-sans sm:text-6xl md:text-5xl xl:text-6xl">
              Evinin rahatlığında matematik fulleten seri
            </p>
            <div className="flex">
              <p className="my-auto md:mt-5 text-2xl">
                Yolda zaman kaybetme, evde dershane kalitesinde konulara çalış.
              </p>
              <img
                src="https://www.afmmagaza.com/resman/uploads/2286405.jpg"
                className="h-64 md:h-96 md:hidden"
              />
            </div>
            <div className="sm:flex justify-center md:justify-start my-3 lg:my-10">
              <div className="w-full md:w-1/2">
                <a
                  className="whitespace-nowrap flex mx-3 justify-center items-center rounded-md shadow-lg font-semibold bg-green-600 hover:bg-green-500 text-lg text-white py-4 ml-3 border border-transparent md:py-4 md:text-lg md:px-10"
                  href="#"
                >
                  Ücretsiz Başla
                </a>
              ...
              <div className="w-full md:w-1/2">
                <Link href="/Login">
                  <a className="flex mx-3 justify-center items-center rounded-md shadow-md font-semibold bg-white text-lg text-green-600 hover:bg-gray-50 py-4 ml-3 border border-transparent md:py-4 md:text-lg md:px-10">
                    {" "}
                    Giriş Yap
                  </a>
                </Link>
        ...
        <img
          src="https://www.afmmagaza.com/resman/uploads/2286405.jpg"
          className="absolute transform scale-125 z-0  right-64 top-1/2 translate-x-1/2 xl:translate-x-1/5 -translate-y-1/2 h-0 md:h-full "
        />
      </div>
      {/* <div className=" relative bg-white overflow-hidden">
                <div className=" py-24 mx-auto container px-4 sm:mt-12  relative">
                    <img src="https://www.afmmagaza.com/resman/uploads/2286405.jpg" alt="React Query Emblem" className="z-0 absolute transform right-96 top-1/2 h-0 md:h-full scale-100 translate-x-1/2 xl:translate-x-1/5 -translate-y-1/2" />
                    <div className=" grid grid-cols-12 md:gap-8  ">
                        <div className=" col-span-12 md:col-span-6 z-10">
                            <div className=" text-center md:text-left md:max-w-2xl md:mx-auto ">
                                <h1 className=" text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none sm:text-6xl md:text-5xl xl:text-6xl">Performant and powerful data
                                        <span className="">synchronization for React</span>
                                </h1>
                                <p className=" mt-3 text-base text-gray-700 sm:mt-5 sm:text-xl md:text-lg xl:text-xl">Fetch, cache and update data in your React and React Native applications all without touching any "global state".</p>
